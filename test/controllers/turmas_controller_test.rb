...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { horario: @turma.horario, modulo: @turma.modulo, nome: @turma.nome } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { horario: @turma.horario, modulo: @turma.modulo, nome: @turma.nome } }
